        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="card text-white bg-secondary">
                    <div class="card-body form-group mb-0">
                        <form method="POST" action="{{ route('pharmacy.salesCart.store', $storeId) }}" id="add_item_form">
                            @csrf
                            ...
                            <table id="sales-table" class="table table-hover table-cis">
                                ...
                                <tbody>
                                    @forelse ($cartItems as $key => $item)
                                        ...
                                        <form 
                                            action="{{ route('pharmacy.salesCart.destroy', [$storeId, $item->id]) }}"
                                        ...
                                        <form
                                            method="POST"
                                            action="{{ route('pharmacy.salesCart.update', [$storeId, $item->id]) }}"
                                            ...
                                            <tr>
                                                <td>
                                                    <a
                                                        href="{{ route('pharmacy.salesCart.destroy', [$storeId, $item->id]) }}"
            ...
            <div class="col-md-4">
                <div class="card text-white bg-secondary">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('pharmacy.sales.store', $storeId) }}">
                            <table class="payment-totals mb-4">
                                <tbody>
                                    <tr>
                                        <td style="width: 55%;">Amount Due</td>
